...
export const WIDGETS: Record<WidgetKey, WidgetMeta> = {
  ...
  temp: { key: "temp", label: "Temperatury", desc: "Temperatury pomieszczeń", icon: Thermometer, route: "/climate", defaultSize: "m", render: () => <TempWidget />, gradient: "from-sky-500/40 to-indigo-500/20" },
