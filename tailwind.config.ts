...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        "accordion-down": "accordion-down 0.25s var(--ease-smooth)",
        "accordion-up": "accordion-up 0.25s var(--ease-smooth)",
        "fade-in": "fade-in .45s var(--ease-smooth) both",
        "fade-out": "fade-out .3s var(--ease-smooth) both",
        "scale-in": "scale-in .3s var(--ease-smooth) both",
        "slide-up": "slide-up .5s var(--ease-smooth) both",
        "slide-in-right": "slide-in-right .35s var(--ease-smooth) both",
        shimmer: "shimmer 2.4s linear infinite",
        "pulse-glow": "pulse-glow 2s var(--ease-smooth) infinite",
        float: "float 6s ease-in-out infinite",
        "spin-slow": "spin 12s linear infinite",
        "count-up": "count-up .6s var(--ease-smooth) both",
      },
    },
  },
